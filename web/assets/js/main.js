...
(function($) {
    ...
    /* =  金蝶视频播放
    /*-------------------------------------------------*/
    $('.popup-vimeo').on('click',function(e){
        e.preventDefault()
        $('.popup-vimeo').addClass('popup-vimeo-play');
        var pic = $('.popup-vimeo > img')[0];
        var vid = $('.popup-vimeo > video')[0];
        ...
        vid.onended=function(){
            ...
            $('.popup-vimeo').removeClass('popup-vimeo-play');                         
        }   
        console.log('e',e,pic,vid);
    });
    /*-------------------------------------------------*/
    /* =  Menu
    /*-------------------------------------------------*/
